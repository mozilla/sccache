...
use futures01::task::{self, Task};
use futures01::{future, stream, Async, AsyncSink, Future, Poll, Sink, StartSend, Stream};
...
impl<C: CommandCreatorSync> SccacheServer<C> {
    ...
    fn _run<'a>(self, shutdown: Box<dyn Future<Item = (), Error = ()> + 'a>) -> io::Result<()> {
        ...
        let server = listener.incoming().for_each(move |socket| {
            ...
            tokio01::runtime::current_thread::TaskExecutor::current()
