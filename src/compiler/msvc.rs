    ...
    fn handle_response_file_with_quotes() {
        ...
        assert_eq!(parsed, ParsedArguments {
            ...
            preprocessor_args: ovec![
                ...
                "-D_WINDLL",
                "-I.",
                "-IEditorGraphEditorPrivate",
                "-IEditorGraphEditorPrivateKismetNodes",
                "-IEditorGraphEditorPrivateKismetPins",
                "-IEditorGraphEditorPrivateMaterialNodes",
                "-IEditorGraphEditorPrivateMaterialPins",
                "-IRuntime",
                "-IRuntimeAppFrameworkPublic",
                "-IRuntimeCorePublic",
                "-I..IntermediateBuildWin64UE4EditorIncCoreUObject",
                "-IRuntimeCoreUObjectPublic",
                "-IRuntimeApplicationCorePublic",
                "-IRuntimeRHIPublic",
                "-I..IntermediateBuildWin64UE4EditorIncSlate",
                "-IRuntimeSlatePublic",
                "-I..IntermediateBuildWin64UE4EditorIncInputCore",
                "-IRuntimeInputCoreClasses",
                "-IRuntimeInputCorePublic",
                "-IRuntimeJsonPublic",
                "-I..IntermediateBuildWin64UE4EditorIncSlateCore",
                "-IRuntimeSlateCorePublic",
                "-IRuntimeImageWrapperPublic",
                "-I..IntermediateBuildWin64UE4EditorIncEngine",
                "-IRuntimeEngineClasses",
                "-IRuntimeEnginePublic",
                "-IRuntimeMessagingPublic",
                "-IRuntimeMessagingCommonPublic",
                "-IRuntimeRenderCorePublic",
                "-IRuntimeShaderCorePublic",
                "-IRuntimeUtilityShadersPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAssetRegistry",
                "-IRuntimeAssetRegistryPublic",
                "-I..IntermediateBuildWin64UE4EditorIncEngineMessages",
                "-IRuntimeEngineMessagesPublic",
                "-I..IntermediateBuildWin64UE4EditorIncEngineSettings",
                "-IRuntimeEngineSettingsClasses",
                "-IRuntimeEngineSettingsPublic",
                "-IRuntimeSynthBenchmarkPublic",
                "-I..IntermediateBuildWin64UE4EditorIncRenderer",
                "-IRuntimeRendererPublic",
                "-I..IntermediateBuildWin64UE4EditorIncGameplayTags",
                "-IRuntimeGameplayTagsClasses",
                "-IRuntimeGameplayTagsPublic",
                "-IRuntimeDatabaseSupportPublic",
                "-I..IntermediateBuildWin64UE4EditorIncPacketHandler",
                "-IRuntimePacketHandlers",
                "-IRuntimePacketHandlersPacketHandlerClasses",
                "-IRuntimePacketHandlersPacketHandlerPublic",
                "-IRuntimePacketHandlersReliabilityHandlerComponentPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAudioPlatformConfiguration",
                "-IRuntimeAudioPlatformConfigurationPublic",
                "-I..IntermediateBuildWin64UE4EditorIncMeshDescription",
                "-IRuntimeMeshDescriptionPublic",
                "-I..IntermediateBuildWin64UE4EditorIncUnrealEd",
                "-IEditor",
                "-IProgramsUnrealLightmassPublic",
                "-IEditorUnrealEdClasses",
                "-IEditorUnrealEdPublic",
                "-IEditorBspModePublic",
                "-IDeveloper",
                "-IDeveloperDirectoryWatcherPublic",
                "-IEditorDocumentationPublic",
                "-IRuntimeProjectsPublic",
                "-IRuntimeSandboxFilePublic",
                "-I..IntermediateBuildWin64UE4EditorIncEditorStyle",
                "-IEditorEditorStylePublic",
                "-I..IntermediateBuildWin64UE4EditorIncSourceControl",
                "-IDeveloperSourceControlPublic",
                "-I..IntermediateBuildWin64UE4EditorIncUnrealEdMessages",
                "-IEditorUnrealEdMessagesClasses",
                "-IEditorUnrealEdMessagesPublic",
                "-I..IntermediateBuildWin64UE4EditorIncGameplayDebugger",
                "-IDeveloperGameplayDebuggerPublic",
                "-I..IntermediateBuildWin64UE4EditorIncBlueprintGraph",
                "-IEditorBlueprintGraphClasses",
                "-IEditorBlueprintGraphPublic",
                "-IRuntimeOnline",
                "-IRuntimeOnlineHTTPPublic",
                "-IRuntimeUnrealAudioPublic",
                "-I..IntermediateBuildWin64UE4EditorIncFunctionalTesting",
                "-IDeveloperFunctionalTestingClasses",
                "-IDeveloperFunctionalTestingPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAutomationController",
                "-IDeveloperAutomationControllerPublic",
                "-I..IntermediateBuildWin64UE4EditorIncLocalization",
                "-IDeveloperLocalizationPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAudioEditor",
                "-IEditorAudioEditorClasses",
                "-IEditorAudioEditorPublic",
                "-IEditorLevelEditorPublic",
                "-IDeveloperSettingsPublic",
                "-I..IntermediateBuildWin64UE4EditorIncIntroTutorials",
                "-IEditorIntroTutorialsPublic",
                "-I..IntermediateBuildWin64UE4EditorIncHeadMountedDisplay",
                "-IRuntimeHeadMountedDisplayPublic",
                "-I..IntermediateBuildWin64UE4EditorIncVREditor",
                "-IEditorVREditor",
                "-IEditorVREditorPublic",
                "-IEditorCommonMenuExtensionsPublic",
                "-I..IntermediateBuildWin64UE4EditorIncLandscape",
                "-IRuntimeLandscapeClasses",
                "-IRuntimeLandscapePublic",
                "-IEditorPropertyEditorPublic",
                "-IEditorActorPickerModePublic",
                "-IEditorSceneDepthPickerModePublic",
                "-IEditorDetailCustomizationsPublic",
                "-I..IntermediateBuildWin64UE4EditorIncClassViewer",
                "-IEditorClassViewerPublic",
                "-I..IntermediateBuildWin64UE4EditorIncGraphEditor",
                "-IEditorGraphEditorPublic",
                "-I..IntermediateBuildWin64UE4EditorIncContentBrowser",
                "-IEditorContentBrowserPublic",
                "-IRuntimeNetworkFileSystemPublic",
                "-IRuntimeSocketsPublic",
                "-I..IntermediateBuildWin64UE4EditorIncUMG",
                "-IRuntimeUMGPublic",
                "-I..IntermediateBuildWin64UE4EditorIncMovieScene",
                "-IRuntimeMovieScenePublic",
                "-I..IntermediateBuildWin64UE4EditorIncTimeManagement",
                "-IRuntimeTimeManagementPublic",
                "-I..IntermediateBuildWin64UE4EditorIncMovieSceneTracks",
                "-IRuntimeMovieSceneTracksPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAnimationCore",
                "-IRuntimeAnimationCorePublic",
                "-I..IntermediateBuildWin64UE4EditorIncPropertyPath",
                "-IRuntimePropertyPathPublic",
                "-I..IntermediateBuildWin64UE4EditorIncNavigationSystem",
                "-IRuntimeNavigationSystemPublic",
                "-IDeveloperMeshBuilderPublic",
                "-IRuntimeWindows",
                "-IRuntimeWindowsXAudio2Public",
                "-IRuntimeAudioMixerPublic",
                "-IDeveloperCollectionManagerPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAddContentDialog",
                "-IEditorAddContentDialogPublic",
                "-IThirdPartyIntelEmbreeEmbree2140Win64include",
                "-IDeveloperMeshUtilitiesPublic",
                "-IDeveloperMeshMergeUtilitiesPublic",
                "-IDeveloperHierarchicalLODUtilitiesPublic",
                "-IDeveloperMeshReductionInterfacePublic",
                "-I..IntermediateBuildWin64UE4EditorIncAssetTools",
                "-IDeveloperAssetToolsPublic",
                "-IEditorKismetCompilerPublic",
                "-I..IntermediateBuildWin64UE4EditorIncGameplayTasks",
                "-IRuntimeGameplayTasksClasses",
                "-IRuntimeGameplayTasksPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAIModule",
                "-IRuntimeAIModulePublic",
                "-IRuntimeAIModuleClasses",
                "-I..IntermediateBuildWin64UE4EditorIncKismet",
                "-IEditorKismetClasses",
                "-IEditorKismetPublic",
                "-I..IntermediateBuildWin64UE4EditorIncClothingSystemRuntimeInterface",
                "-IRuntimeClothingSystemRuntimeInterfacePublic",
                "-IRuntimeNetworkReplayStreaming",
                "-IRuntimeNetworkReplayStreamingNetworkReplayStreamingPublic",
                "-I..IntermediateBuildWin64UE4EditorIncAudioMixer",
                "-IRuntimeAudioMixerClasses",
                "-IThirdParty",
                "-IThirdPartylibSampleRatePublic",
                "-IEditorEditorWidgetsPublic",
                "-IEditorKismetWidgetsPublic",
