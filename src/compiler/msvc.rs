...
mod test {
    ...
    fn handle_response_file_with_quotes() {
        ...
        let td = TempDir::new("msvc_response_file").unwrap();
        let rsp_path = td.path().join("Module.GraphEditor.cpp.obj.response");

        std::fs::copy("tests/Module.GraphEditor.cpp.obj.response", &rsp_path).unwrap();

        let parsed = match parse_arguments(&ovec![format!("@{}", rsp_path.display())]) {
            CompilerArguments::Ok(args) => args,
            o @ _ => panic!("Got unexpected parse result: {:?}", o),
        };
        
        assert_eq!(parsed, ParsedArguments {
            input: PathBuf::from(r#"C:\code\UnrealEngine\Engine\Intermediate\Build\Win64\UE4Editor\Development\GraphEditor\Module.GraphEditor.cpp"#),
            language: Language::Cxx,
            depfile: None,
            outputs: vec![("obj", PathBuf::from(r#"C:\code\UnrealEngine\Engine\Intermediate\Build\Win64\UE4Editor\Development\GraphEditor\Module.GraphEditor.cpp.obj"#))].into_iter().collect(),
            preprocessor_args: ovec![
                ...
                r#"-IEditor\GraphEditor\Private\KismetNodes"#,
                r#"-IEditor\GraphEditor\Private\KismetPins"#,
                r#"-IEditor\GraphEditor\Private\MaterialNodes"#,
                r#"-IEditor\GraphEditor\Private\MaterialPins"#,
                r#"-IRuntime"#,
                r#"-IRuntime\AppFramework\Public"#,
                r#"-IRuntime\Core\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\CoreUObject"#,
                r#"-IRuntime\CoreUObject\Public"#,
                r#"-IRuntime\ApplicationCore\Public"#,
                r#"-IRuntime\RHI\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Slate"#,
                r#"-IRuntime\Slate\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\InputCore"#,
                r#"-IRuntime\InputCore\Classes"#,
                r#"-IRuntime\InputCore\Public"#,
                r#"-IRuntime\Json\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\SlateCore"#,
                r#"-IRuntime\SlateCore\Public"#,
                r#"-IRuntime\ImageWrapper\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Engine"#,
                r#"-IRuntime\Engine\Classes"#,
                r#"-IRuntime\Engine\Public"#,
                r#"-IRuntime\Messaging\Public"#,
                r#"-IRuntime\MessagingCommon\Public"#,
                r#"-IRuntime\RenderCore\Public"#,
                r#"-IRuntime\ShaderCore\Public"#,
                r#"-IRuntime\UtilityShaders\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AssetRegistry"#,
                r#"-IRuntime\AssetRegistry\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\EngineMessages"#,
                r#"-IRuntime\EngineMessages\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\EngineSettings"#,
                r#"-IRuntime\EngineSettings\Classes"#,
                r#"-IRuntime\EngineSettings\Public"#,
                r#"-IRuntime\SynthBenchmark\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Renderer"#,
                r#"-IRuntime\Renderer\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\GameplayTags"#,
                r#"-IRuntime\GameplayTags\Classes"#,
                r#"-IRuntime\GameplayTags\Public"#,
                r#"-IRuntime\DatabaseSupport\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\PacketHandler"#,
                r#"-IRuntime\PacketHandlers"#,
                r#"-IRuntime\PacketHandlers\PacketHandler\Classes"#,
                r#"-IRuntime\PacketHandlers\PacketHandler\Public"#,
                r#"-IRuntime\PacketHandlers\ReliabilityHandlerComponent\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AudioPlatformConfiguration"#,
                r#"-IRuntime\AudioPlatformConfiguration\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\MeshDescription"#,
                r#"-IRuntime\MeshDescription\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\UnrealEd"#,
                r#"-IEditor"#,
                r#"-IPrograms\UnrealLightmass\Public"#,
                r#"-IEditor\UnrealEd\Classes"#,
                r#"-IEditor\UnrealEd\Public"#,
                r#"-IEditor\BspMode\Public"#,
                r#"-IDeveloper"#,
                r#"-IDeveloper\DirectoryWatcher\Public"#,
                r#"-IEditor\Documentation\Public"#,
                r#"-IRuntime\Projects\Public"#,
                r#"-IRuntime\SandboxFile\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\EditorStyle"#,
                r#"-IEditor\EditorStyle\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\SourceControl"#,
                r#"-IDeveloper\SourceControl\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\UnrealEdMessages"#,
                r#"-IEditor\UnrealEdMessages\Classes"#,
                r#"-IEditor\UnrealEdMessages\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\GameplayDebugger"#,
                r#"-IDeveloper\GameplayDebugger\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\BlueprintGraph"#,
                r#"-IEditor\BlueprintGraph\Classes"#,
                r#"-IEditor\BlueprintGraph\Public"#,
                r#"-IRuntime\Online"#,
                r#"-IRuntime\Online\HTTP\Public"#,
                r#"-IRuntime\UnrealAudio\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\FunctionalTesting"#,
                r#"-IDeveloper\FunctionalTesting\Classes"#,
                r#"-IDeveloper\FunctionalTesting\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AutomationController"#,
                r#"-IDeveloper\AutomationController\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Localization"#,
                r#"-IDeveloper\Localization\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AudioEditor"#,
                r#"-IEditor\AudioEditor\Classes"#,
                r#"-IEditor\AudioEditor\Public"#,
                r#"-IEditor\LevelEditor\Public"#,
                r#"-IDeveloper\Settings\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\IntroTutorials"#,
                r#"-IEditor\IntroTutorials\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\HeadMountedDisplay"#,
                r#"-IRuntime\HeadMountedDisplay\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\VREditor"#,
                r#"-IEditor\VREditor"#,
                r#"-IEditor\VREditor\Public"#,
                r#"-IEditor\CommonMenuExtensions\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Landscape"#,
                r#"-IRuntime\Landscape\Classes"#,
                r#"-IRuntime\Landscape\Public"#,
                r#"-IEditor\PropertyEditor\Public"#,
                r#"-IEditor\ActorPickerMode\Public"#,
                r#"-IEditor\SceneDepthPickerMode\Public"#,
                r#"-IEditor\DetailCustomizations\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\ClassViewer"#,
                r#"-IEditor\ClassViewer\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\GraphEditor"#,
                r#"-IEditor\GraphEditor\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\ContentBrowser"#,
                r#"-IEditor\ContentBrowser\Public"#,
                r#"-IRuntime\NetworkFileSystem\Public"#,
                r#"-IRuntime\Sockets\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\UMG"#,
                r#"-IRuntime\UMG\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\MovieScene"#,
                r#"-IRuntime\MovieScene\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\TimeManagement"#,
                r#"-IRuntime\TimeManagement\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\MovieSceneTracks"#,
                r#"-IRuntime\MovieSceneTracks\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AnimationCore"#,
                r#"-IRuntime\AnimationCore\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\PropertyPath"#,
                r#"-IRuntime\PropertyPath\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\NavigationSystem"#,
                r#"-IRuntime\NavigationSystem\Public"#,
                r#"-IDeveloper\MeshBuilder\Public"#,
                r#"-IRuntime\Windows"#,
                r#"-IRuntime\Windows\XAudio2\Public"#,
                r#"-IRuntime\AudioMixer\Public"#,
                r#"-IDeveloper\CollectionManager\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AddContentDialog"#,
                r#"-IEditor\AddContentDialog\Public"#,
                r#"-IThirdParty\IntelEmbree\Embree2140\Win64\include"#,
                r#"-IDeveloper\MeshUtilities\Public"#,
                r#"-IDeveloper\MeshMergeUtilities\Public"#,
                r#"-IDeveloper\HierarchicalLODUtilities\Public"#,
                r#"-IDeveloper\MeshReductionInterface\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AssetTools"#,
                r#"-IDeveloper\AssetTools\Public"#,
                r#"-IEditor\KismetCompiler\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\GameplayTasks"#,
                r#"-IRuntime\GameplayTasks\Classes"#,
                r#"-IRuntime\GameplayTasks\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AIModule"#,
                r#"-IRuntime\AIModule\Public"#,
                r#"-IRuntime\AIModule\Classes"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\Kismet"#,
                r#"-IEditor\Kismet\Classes"#,
                r#"-IEditor\Kismet\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\ClothingSystemRuntimeInterface"#,
                r#"-IRuntime\ClothingSystemRuntimeInterface\Public"#,
                r#"-IRuntime\NetworkReplayStreaming"#,
                r#"-IRuntime\NetworkReplayStreaming\NetworkReplayStreaming\Public"#,
                r#"-I..\Intermediate\Build\Win64\UE4Editor\Inc\AudioMixer"#,
                r#"-IRuntime\AudioMixer\Classes"#,
                r#"-IThirdParty"#,
                r#"-IThirdParty\libSampleRate\Public"#,
                r#"-IEditor\EditorWidgets\Public"#,
                r#"-IEditor\KismetWidgets\Public"#,
                r#"-IC:\Program Files (x86)\Microsoft Visual Studio\2017\Community\VC\Tools\MSVC\14.16.27023\INCLUDE"#,
                r#"-IC:\Program Files (x86)\Windows Kits\NETFXSDK\4.6.1\include\um"#,
                r#"-IC:\Program Files (x86)\Windows Kits\10\include\10.0.17763.0\ucrt"#,
                r#"-IC:\Program Files (x86)\Windows Kits\10\include\10.0.17763.0\shared"#,
                r#"-IC:\Program Files (x86)\Windows Kits\10\include\10.0.17763.0\um"#,
                r#"-IC:\Program Files (x86)\Windows Kits\10\include\10.0.17763.0\winrt"#,
                r#"-FIC:\code\UnrealEngine\Engine\Intermediate\Build\Win64\UE4Editor\Development\UnrealEd\SharedPCH.UnrealEd.h"#,
                r#"-FIC:\code\UnrealEngine\Engine\Intermediate\Build\Win64\UE4Editor\Development\GraphEditor\Definitions.GraphEditor.h"#,
            ],
            common_args: ovec![
                "-Zc:inline",
                "-nologo",
                ...
                "-wd4838",
                "-we4668",
                r#"-YuC:\code\UnrealEngine\Engine\Intermediate\Build\Win64\UE4Editor\Development\UnrealEd\SharedPCH.UnrealEd.h"#,
                "-TP",
                "-GR-",
                "-W4",
            ],
