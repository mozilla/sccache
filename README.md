...
sccache is a [Rust](https://www.rust-lang.org/) program. Building it requires `cargo` (and thus `rustc`). sccache currently requires **Rust 1.42.0**. We recommend you install Rust via [Rustup](https://rustup.rs/).
